...
def build_cta_extension():
    ...
    # Max TMDS 0xEE = 238 * 5 = 1190 MHz (covers 4K@120 which needs 1188 MHz)
    data.extend([0x66, 0x03, 0x0C, 0x00, 0x10, 0x00, 0xEE])

    # HDMI Forum VSDB (OUI C4-5D-D8) — HDMI 2.1 / SCDC
    # Max TMDS 0xEE = 1190 MHz, SCDC present
    data.extend([0x67, 0xD8, 0x5D, 0xC4, 0x01, 0xEE, 0x80, 0x00])
